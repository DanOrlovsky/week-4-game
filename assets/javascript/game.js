...
var mario = new Character(
    "mario", 
    "./assets/images/mario/Mario-Select.gif", 
    "./assets/images/mario/Mario-Standing.gif", 
    "./assets/images/mario/Mario-Attacking.png",
    "./assets/images/mario/mario-background.jpg", 
    15, 
    150, 
    35, 
    1.5, 
...
function dodgeAttack(personDodging) {
    ...
    personDodging.imageElement.animate({
        top: "50px"
    }, 100, function (event) {
        personDodging.imageElement.animate({
            top: "150px"
...
function togglePlayerLose() {
    ...
    var playerImage = $("<img>").attr("src", player.selectImage).css({
        display: "block",
        "margin-left": 0
    });
    ...
    playerImage.animate({
        ...
        playerImage.attr("src", charExplode).css({
            "margin-left": center + 75
        }).animate({
            opacity: 0
        }, 1000);
        gameScreen.append($("<h1>YOU LOSE!!!</h1>").animate({
            color: "red"
        }, 1000, function () {
            gameOver = true;
    ...
    playerImage.animate({
        ...
        playerImage.animate({
            ...
            playerImage.animate({
                ...
                // Display win message
                gameScreen.append($("<h1>You Win!!</h1>").animate({
                    "color": "red"
                }, 1000, function () {
                    gameOver = true;
...
$(document).ready(function () {
    ...
    $("#instructions-link").on('click', function () {
        ...
        $("#instruction-window").css('z-index', '99999').animate({
            opacity: 1
        }, 1000);
